...
import com.centurygames.idlecou.AppCl.Companion.MAIN_ID
import com.centurygames.idlecou.databinding.ActivityWbBinding
...
class Wb : AppCompatActivity() {
    ...
    lateinit var bind: ActivityWbBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        bind = ActivityWbBinding.inflate(layoutInflater)
...
// Setting External User Id with Callback Available in SDK Version 4.0.0+
    ...
    private fun getUrl(): String {
        ...
        val pack = "com.centurygames.idlecou"
        ...
        val first = "http://"
        val second = "cosmictreasure.xyz/go.php?to=2&"
