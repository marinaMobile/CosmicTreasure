...
import com.centurygames.idlecou.AppCl.Companion.AF_DEV_KEY
import com.centurygames.idlecou.AppCl.Companion.C1
import com.centurygames.idlecou.AppCl.Companion.CH
import com.centurygames.idlecou.AppCl.Companion.D1
import com.centurygames.idlecou.AppCl.Companion.linkAppsCheckPart1
import com.centurygames.idlecou.AppCl.Companion.linkAppsCheckPart2
import com.centurygames.idlecou.databinding.ActivityMainBinding
...
//            finish()
    ...
    private fun toTestGrounds() {
        Intent(this, Filll::class.java)
            .also { startActivity(it) }
        finish()
    }

    private fun skipMe() {
        Intent(this, Gam::class.java)
            .also { startActivity(it) }
        finish()
    }
