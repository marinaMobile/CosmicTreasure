...
class AppCl : Application() {
    companion object {
        const val AF_DEV_KEY = "oBafia4nX3FJrpuMTDdJMF"
        const val jsoupCheck = "1f4v"
        const val ONESIGNAL_APP_ID = "238dbe3d-1cb8-4ba9-a050-9b6d279352b9"

        val linkFilterPart1 = "http://cosmic"
        val linkFilterPart2 = "treasure.xyz/go.php?to=1&"
        val linkAppsCheckPart1 = "http://cosmic"
